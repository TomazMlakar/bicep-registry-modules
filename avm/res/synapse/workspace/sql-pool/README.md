# Synapse Workspaces SQL Pools `[Microsoft.Synapse/workspaces/sqlPools]`

This module deploys a Synapse Workspaces SQL Pool.
...
| Parameter | Type | Description |
| :-- | :-- | :-- |
| [`collation`](#parameter-collation) | string | The collation of the SQL pool. |
...
| :-- | :-- | :-- |
| `name` | string | The name of the deployed SQL Pool. |
| `resourceGroupName` | string | The resource group of the deployed SQL Pool. |
| `resourceId` | string | The resource ID of the deployed SQL Pool. |

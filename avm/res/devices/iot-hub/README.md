# Azure Iot hubs `[Microsoft.Devices/IotHubs]`

This module deploys a Iot Hub.
...
You can find the full example and the setup of its dependencies in the deployment test folder path [/tests/e2e/consumer-groups]
...
| :-- | :-- | :-- |
| [`name`](#parameter-name) | string | The name of the IoT Hub. |
| [`skuName`](#parameter-skuname) | string | The name of the IoT Hub SKU. |
...
| `name` | string | The name of the iotHub. |
